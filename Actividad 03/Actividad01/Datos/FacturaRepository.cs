    ...
    public class FacturaRepository : IFacturaRepository
    {
        public List<Factura> GetAll()
        {
            ...
            foreach (DataRow row in t.Rows)
            {
                ...
                var detalles = GetDetallesById(id);
                DateTime fecha = Convert.ToDateTime(row["fecha"]);
                int codFormaPago = Convert.ToInt32(row["id_formaPago"]);
        ...
        public List<DetalleFactura> GetDetallesById(int id)
        {
            ...
            if (t != null)
            {
                foreach (DataRow row in t.Rows)
                {
                    ...
                    int codArt = Convert.ToInt32(row["id_articulo"]);
        ...
        public bool Save(Factura oFactura)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@codFPago", oFactura.FormPago.IdFp);
